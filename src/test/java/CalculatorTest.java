...
public class CalculatorTest {
    ...
    public void powerFalsePositive(){
        ...
        assertNotEquals("Finding power for False Positive", -6.7, calculator.power(3, 3), DELTA);
    }
    ...
    public void logFalsePositive(){
        assertNotEquals("Finding natural log for False Positive", 6.2, calculator.naturalLog(2.6), DELTA);
        assertNotEquals("Finding natural log for False Positive", 7.0, calculator.naturalLog(2), DELTA);
    }
    ...
    public void sqrootFalsePositive(){
        assertNotEquals("Finding square root for False Positive", 5, calculator.sqroot(10), DELTA);
        assertNotEquals("Finding square root for False Positive", 11, calculator.sqroot(22), DELTA);
